...
public class FindingTheTopicOfEachPost{
	public static void main(String[] args) {
		Solution solution = new FindingTheTopicOfEachPost().new Solution();
		
	}
#leetcode submit region begin(Prohibit modification and deletion)
# Write your MySQL query statement below

select a.post_id,ifnull(group_concat(distinct b.topic_id order by b.topic_id),'Ambiguous!') topic from Posts a left join Keywords b
on a.content like concat('% ',b.word) or a.content like concat(b.word,' %') or a.content like concat('% ',b.word,' %')
group by a.post_id
